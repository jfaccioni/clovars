...
from clovars.gui.cell_signal import ParamWidget, _get_params
...
class CellSignalModel:
    ...
    def __post_init__(self) -> None:
        ...
        self.param_models = _get_params(signal_name=self.name)
...
class CellSignalWidget(qtw.QWidget):
    ...
    def __init__(
        ...
        for param_model in self.model:
            param_widget = ParamWidget(model=param_model)
